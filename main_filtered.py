...
if __name__ == '__main__':
    ...
    dataset_file = 'train_val_dataset_12_200_filtered'
    ...
    # create the model
    NN = CNN()
    model = NN.CNN1D_Dense(train_data_np.shape[1:], category_No)
    ...
    # model.compile(loss='sparse_categorical_crossentropy',  # no accuracy improvement
