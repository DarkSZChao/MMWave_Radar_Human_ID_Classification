...
if __name__ == '__main__':
    ...
    dataset_file = 'train_val_dataset_12_200_filtered_timelen_20_step5'
    ...
    train_data_np, train_labels_np, val_data_np, val_labels_np, category_No = generate_dataset(data_np, labels_np, split_ratio=(0.89, 0.11), label_categorical=False, test_data_enable=False)
    ...
    # create the model
    NN = CNN()
    model = NN.CNN1D_Dense_Tnet_GMPooling_LSTM(train_data_np.shape[1:], category_No)
    ...
    # save history
    with open(os.path.join(MODEL_SAVE_DIR, 'model_filtered_history'), 'wb') as f:
